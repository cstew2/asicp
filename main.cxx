...
void test_asicp(void)
{
	...
	Eigen::Matrix3d R = (Eigen::AngleAxisd(M_PI/6, Eigen::Vector3d::UnitX()).matrix() *
			     Eigen::AngleAxisd(M_PI/6, Eigen::Vector3d::UnitY()).matrix() *
			     Eigen::AngleAxisd(M_PI/6, Eigen::Vector3d::UnitZ()).matrix());
	
	//Eigen::Matrix3d S = Eigen::Vector3d::Random(3).asDiagonal() * 2.0;
	Eigen::Matrix3d S = Eigen::Matrix3d::Identity() * 1;
